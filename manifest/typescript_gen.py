...
def generate_compact_instructions(
    ...
    lines = [
        ...
        "  - timeout_secs: execution timeout (default: 60)",
        ...
        "",
        "SEARCH:",
        "  mcproxy(action='search', query='...')  # Find tools",
        "  mcproxy(action='search')                # List all servers",
        "",
        "INSPECT:",
        "  mcproxy(action='inspect', server='name', tool='...')",
        "  # Returns tool schema without executing",
        "",
        "Available servers:",
    ]
