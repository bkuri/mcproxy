...
def generate_compact_instructions(
    ...
    lines = [
        ...
        "  mcproxy_search    - Discover tools when unknown (optional)",
        "",
        "Usage: mcproxy_execute(code=\"api.server('server_name').tool_name(arg=value)\")",
        "Example: mcproxy_execute(code=\"api.server('wikipedia').search(query='python')\")",
        "",
